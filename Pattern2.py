...
while i < n1 and result:
    ...
    ln1_char = ln1[i] #get i-character from ln1
    ln2_char = ln2[i]#get i-character from ln2
    ...
    is_ln1_char_processed = ln1_char.__contains__(ln1_char)#check processed_chars does not contain character[i] from line 1
    is_ln2_char_processed = ln2_char.__contains__(ln2_char)#check processed_chars does not contain character[i] from line 2
    ...
    if not(is_ln1_char_processed) and not(is_ln2_char_processed):
        ...
        processed_chars += ln1_char + ln2_char#...
        ...
        result = False #Think what result should be equal to, if i-character already was processed before, but j-character was not processed yet?
        ...
        result = False#Think what result should be equal to, if i-character has not been processed before, but j-character has already been processed?
    else:
